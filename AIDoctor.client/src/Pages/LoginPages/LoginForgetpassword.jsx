...
export default function LoginForgetPassword() {
  return (
    <div className="flex justify-center items-center min-h-screen w-full bg-gradient-to-br bg-blue-100 animate-fadeIn px-4">
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-sm border-t-4 border-blue-500 transition duration-300 hover:shadow-2xl hover:scale-[1.02]">
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-between text-sm text-gray-700 font-medium">
            ...
            >
              Need help? 
              <img src={questionMark} alt="" className="w-4 h-4 ml-1 opacity-75" />
            </a>
          </div>
