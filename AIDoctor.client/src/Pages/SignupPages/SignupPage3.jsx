    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-white px-4">
      <div>
        <div className="w-full max-w-2xl flex flex-col items-center">
          ...
          <div className='text-2xl font-bold mb-3'>                Two Factor Authentication Setup
</div>
          {/* Progress Bar */}
          ...
          <div className="bg-white border-t-4 border-blue-600 shadow-md p-6 rounded-lg w-full mb-4">
            ...
            <div className="mb-4">
              <label className="text-sm font-medium text-gray-700 block mb-1 text-left">Can't scan? Manual Setup</label>
        ...
        <div className="flex justify-between items-center w-full px-2">
          ...
          <Link to="#">
            <button className="text-md text-blue-600 underline hover:text-blue-800">Need help?</button>
          </Link>
        </div>
      </div>
    </div>
