...
export default function SignupPage2() {
  return (
    <div className="whole-container_11 bg-gradient-to-br bg-blue-100 flex flex-col items-center justify-center min-h-screen w-full overflow-hidden animate-fadeIn">
      <div className="container_11 text-center w-full max-w-xl p-6 rounded-lg animate-fadeInScale">
        ...
        <div className="card_2 bg-gray-50 p-4 rounded-lg border-t-4 border-blue-500 shadow-md animate-fadeInScale">
          ...
          <div className="manual-setup_11 mt-4">
            ...
            <input
              ...
              readOnly
              className="w-full p-3 border border-gray-300 rounded-lg bg-white text-gray-700 mb-4 animate-slideInFromBottom"
            />

            <label className="text-md font-semibold text-gray-700 block mb-2 mr-[400px]">Token Type</label>
            <select className="w-full p-3 border border-gray-300  rounded-lg bg-white text-gray-700 animate-slideInFromBottom">
          ...
          <div className="buttons_11 flex justify-between mt-6 animate-slideInFromBottom">
           <Link to="/signup/step-1"> <button className="back_11 px-5 py-3 bg-gray-300 text-gray-800 rounded-lg font-bold hover:bg-gray-400 transition-transform transform hover:scale-105">
              ← Back
            </button></Link>
           <Link to="/signup/step-3"> <button className="continue_11 px-5 py-3 bg-blue-500 text-white rounded-lg font-bold hover:bg-blue-600 transition-transform transform hover:scale-105">
              Continue →
            </button></Link>
          </div>
        </div>
