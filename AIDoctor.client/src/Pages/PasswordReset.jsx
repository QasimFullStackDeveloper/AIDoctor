...
export default function SetNewPassword() {
  ...
  const evaluateStrength = (pass) => {
    ...
    return { text: "Perfect", color: "green", width: "100%" };
  };
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      <main className="flex-grow flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-[340px] border-t-4 border-blue-600">
          <div className="flex justify-center">
            <div className="justify-center mb-2 h-10 w-10">
              <Logo />
            </div>
          </div>
          ...
          {/* Password Fields */}
          <div className="mt-4">
            <label className="text-xs text-center block mb-1">New Password</label>
            <div className="relative flex items-center border border-gray-300 rounded-lg bg-white p-2 focus-within:ring-2 focus-within:ring-blue-500">
              <input
          ...
          <div className="mt-3">
            <label className="text-xs block text-center mb-1">Confirm Password</label>
            <div className="relative flex items-center border border-gray-300 rounded-lg white p-2 focus-within:ring-2 focus-within:ring-blue-500">
              <input
          ...
          {password.length > 0 && (
            <div className="mt-3">
              <p className="text-xs font-light">Password Strength</p>
              ...
              <div className="text-xs text-gray-600 mt-2 space-y-1 flex flex-col justify-center text-center">
          ...
          >
            <img src={key} alt="Key" className="w-4 h-4" /> Reset Password
          </button>
        </div>
      </main>

      {/* Footer */}
      <footer className="mt-auto py-4 text-xs text-gray-400 w-full flex justify-between items-center">
        <div className="ml-[10%]">
